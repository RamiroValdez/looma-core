...
public class CreateSubscriptionNotification {
    private static final Logger log = LoggerFactory.getLogger(CreateSubscriptionNotification.class);
    ...
    public CreateSubscriptionNotification(NotificationPort notificationPort, 
