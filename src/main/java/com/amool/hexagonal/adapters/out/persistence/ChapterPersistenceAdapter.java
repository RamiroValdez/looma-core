...
public class ChapterPersistenceAdapter implements LoadChapterPort, SaveChapterPort, DeleteChapterPort, UpdateChapterStatusPort, FindChaptersDueForPublicationPort {
