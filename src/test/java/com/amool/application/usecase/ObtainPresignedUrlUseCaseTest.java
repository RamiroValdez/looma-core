...
import com.amool.application.usecases.ObtainPresignedUrlUseCase;
...
public class ObtainPresignedUrlUseCaseTest {

    private AwsS3Port awsS3Port;
    private ObtainPresignedUrlUseCase useCase;

    @BeforeEach
    public void setUp() {
        awsS3Port = Mockito.mock(AwsS3Port.class);
        useCase = new ObtainPresignedUrlUseCase(awsS3Port);
    }
