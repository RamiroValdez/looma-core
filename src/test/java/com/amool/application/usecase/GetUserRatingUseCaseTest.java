...
public class GetUserRatingUseCaseTest {
    ...
    @BeforeEach
    void setUp() {
        getUserRatingUseCase = new GetUserRatingUseCase(ratingPort);
    }
    ...
    void getUserRating_WhenRatingExists_ShouldReturnRating() {
        ...
        Optional<Double> result = getUserRatingUseCase.execute(workId, userId);
    ...
    void getUserRating_WithDifferentUsers_ShouldReturnCorrectRatings() {
        ...
        Optional<Double> result1 = getUserRatingUseCase.execute(workId, userId1);
        Optional<Double> result2 = getUserRatingUseCase.execute(workId, userId2);
